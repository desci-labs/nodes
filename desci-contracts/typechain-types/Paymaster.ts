...
export interface PaymasterInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "targets", values: [string]): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "TargetAdded(address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TargetAdded"): EventFragment;
}
...
export type TargetAddedEvent = TypedEvent<[string], { target: string }>;

export type TargetAddedEventFilter = TypedEventFilter<TargetAddedEvent>;
...
export interface Paymaster extends BaseContract {
  ...
  functions: {
    ...
    targets(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    addTargets(_targets: string[], overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "TargetAdded(address)"(target?: string | null): TargetAddedEventFilter;
    TargetAdded(target?: string | null): TargetAddedEventFilter;
  };
  ...
  estimateGas: {
    ...
    targets(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
