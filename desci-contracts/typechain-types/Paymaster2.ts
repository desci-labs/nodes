...
export interface Paymaster2Interface extends utils.Interface {
  contractName: "Paymaster2";
  functions: {
...
export interface Paymaster2 extends BaseContract {
  contractName: "Paymaster2";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Paymaster2Interface;
