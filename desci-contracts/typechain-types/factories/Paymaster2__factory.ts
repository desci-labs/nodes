...
import type { Paymaster2, Paymaster2Interface } from "../Paymaster2";
...
export class Paymaster2__factory {
  static readonly abi = _abi;
  static createInterface(): Paymaster2Interface {
    return new utils.Interface(_abi) as Paymaster2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Paymaster2 {
    return new Contract(address, _abi, signerOrProvider) as Paymaster2;
  }
}
