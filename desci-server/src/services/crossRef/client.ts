...
class CrossRefClient {
  ...
  async registerDoi(query: {
    ...
    const url = `${process.env.CROSSREF_METADATA_API}?operation=doMDUpload&login_id=${process.env.CROSSREF_LOGIN}/${process.env.CROSSREF_LOGIN_ROLE}&login_passwd=${process.env.CROSSREF_PASSWORD}`;
