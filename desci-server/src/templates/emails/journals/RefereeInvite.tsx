...
export interface RefereeInviteEmailProps {
...
export const RefereeInviteEmail = ({ journal, inviterName, refereeName, submission }: RefereeInviteEmailProps) => (
  <MainLayout>
    <Html>
      <Head />
      <Preview>[{journal.name}] You have been invited to review a submission.</Preview>
      <Body style={baseStyles.main}>
        <Container style={baseStyles.container}>
          <Heading style={baseStyles.h1} className="text-center !text-black">
            [{journal.name}] You have been invited to review a submission by {inviterName} for the {journal.name}
          </Heading>
...
export default RefereeInviteEmail;
