...
export interface DeskRejectionEmailProps {
...
export const DeskRejectionEmail = ({ journal, editor, submission, comments }: DeskRejectionEmailProps) => (
  <MainLayout>
    <Html>
      <Head />
      <Preview>
...
export default DeskRejectionEmail;
