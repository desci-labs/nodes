...
export const MinorRevisionRequestEmail = ({
  ...
  <MainLayout>
    <Html>
      <Head />
      <Preview>
        {journal.name} has requested minor revisions for {submissionTitle}
      </Preview>
      <Body style={baseStyles.main}>
        <Container style={baseStyles.container}>
          <Heading style={baseStyles.h1} className="text-center !text-black">
            {editorName} has requested minor revisions for {submissionTitle}
          </Heading>
...
export default MinorRevisionRequestEmail;
