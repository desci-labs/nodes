...
export const OverdueAlertEditorEmail = ({ journal, submission, reviewDeadline }: OverdueAlertEditorEmailProps) => (
  <MainLayout>
    <Html>
      <Head />
      <Preview>
        [{journal.name}] {submission.title} is overdue
      </Preview>
      <Body style={baseStyles.main}>
        <Container style={baseStyles.container}>
          <Heading style={baseStyles.h1} className="text-center !text-black">
            [{journal.name}] {submission.title} peer review is overdue
          </Heading>
