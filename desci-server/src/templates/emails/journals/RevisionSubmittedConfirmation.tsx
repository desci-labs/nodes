...
export interface RevisionSubmittedEditorEmailProps {
  journal: Pick<Journal, 'id' | 'name' | 'description' | 'iconCid' | 'imageUrl'>;
  submission: SubmissionExtended;
}

export const RevisionSubmittedEditorEmail = ({ journal, submission }: RevisionSubmittedEditorEmailProps) => (
  <MainLayout>
    <Html>
      <Head />
      <Preview>
        [{journal.name}] A revision has been submitted for {submission.title}.
      </Preview>
...
export default RevisionSubmittedEditorEmail;
