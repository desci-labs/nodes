...
export const SENDGRID_WEBHOOK_VERIFY_KEY = process.env.SENDGRID_WEBHOOK_VERIFY_KEY;
...
export const STRIPE_CHECKOUT_FOLLOW_UP_COUPON_ID = process.env.STRIPE_CHECKOUT_FOLLOW_UP_COUPON_ID;
...
export const SCIWEAVE_CHECKOUT_FOLLOW_UP_DISCOUNT_PERCENT = parseInt(
  process.env.SCIWEAVE_CHECKOUT_FOLLOW_UP_DISCOUNT_PC || '10',
  10,
);
