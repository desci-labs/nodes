...
import { setApiKey, getEnvironment, setEnvironment, printCurrentConfig, clearConfig, setPrivateKey, clearPrivateKey, getPrivateKey, WEB_URLS, } from "../config.js";
import { printSuccess, printError, symbols, maskString } from "../ui.js";
export function createConfigCommand() {
    const cmd = new Command("config")
        .description("Manage CLI configuration")
        .option("-k, --api-key <key>", "Set API key")
        .option("-e, --env <environment>", "Set environment (local/dev/staging/prod)")
        ...
        try {
            ...
            // Handle --env
            if (options.env) {
                const validEnvs = ["local", "dev", "staging", "prod"];
    ...
    cmd
        ...
        try {
            ...
            console.log(chalk.dim("This allows you to sign and publish directly from the CLI.\n"));
