...
export abstract class ApiError extends Error {
  constructor(public type: ApiErrorType, public message: string = 'error', public error?: any) {
    super(type);
  }
...
export class BadRequestError extends ApiError {
  constructor(message = 'Bad Request', private err?: unknown) {
    super(ApiErrorType.BAD_REQUEST, message, err);
  }
}
export class UnProcessableRequestError extends ApiError {
  constructor(message = 'Request could not be processed', private err?: unknown) {
