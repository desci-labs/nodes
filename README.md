...
Open source project brought to you by [DeSci Labs](https://desci.com) and the DeSci OSS community.

![DeSci Nodes](./desci-nodes-logo.png)

We are scientists and engineers building tools to make knowledge more accessible and verifiable. We envision a scientific record without data silos, content drift, paywalls, and proprietary analytics. We build technologies for open and reproducible science. We strive to bring simplicity, radical accessibility, and higher efficiency to scientific publishing and funding.

To get onboarded in our open source development effort, hop on our [Discord](https://discord.gg/BeJ4dxXdaJ) or drop us a PR.

Get up to speed with our [user documentation](https://docs.desci.com/using-nodes/getting-started) and [learning materials](https://docs.desci.com/learn/open-state-repository).

Read our [beta announcement post](https://descilabs.substack.com/p/574f74ae-7c4c-4016-9c50-20093d654698) (and follow us on substack!)
